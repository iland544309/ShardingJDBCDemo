...
public class DataSourceConfiguration implements EnvironmentAware {
    ...
    @Autowired
    private DruidDBConfig2 druidDataSource2;
    ...
    public DataSource dataSource(){
        ...
        DataSource duridDataSource2 = druidDataSource2.dataSource();

        Map<String, DataSource> result = new HashMap<String, DataSource>();
        result.put("ds1", duridDataSource1);
        result.put("ds2", duridDataSource2);
    ...
    private TableRuleConfiguration getOrderTableRuleConfiguration() {
        ...
        orderTableRuleConfig.setActualDataNodes("ds${1..2}.t_order_${[201801, 201802, 201803, 201804, 201805, 201806, 201807, 201808, 201809, 201810, 201811, 201812]}");
